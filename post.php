...
Blog Comments  -->
                    ...
                    if(isset($_POST['create_comment'])){
                      ...
                      $query.= " VALUES ($the_post_id, '{$the_comment_author}', '{$the_comment_email}', '{$the_comment_content}', 'unapproved', now())";
...
// $update_c_c=mysqli_query($connection,$query);
                ...
                <hr>
                <div class='form-group'>
                        <a target="_blank" href='https://www.udemy.com/course/advanced-css-and-sass/'>
